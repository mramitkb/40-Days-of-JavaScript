...
/* Explanation 1: `user` object has age as `undefined and we see that there is 
...
obj.a = 2;
// console.log(obj.a);
/* Explanation 2: If we want to try modify this object, we can't be able to do it.
...
/* 3. Given an object with deeply nested properties, extract name, company, and 
...
/* Explanation 7: With `in` operator for an Object, we can find is there has any
...
/* Explanation 8: `person2` and `newPerson` is the same object(with reference value)
...
/* Shallow copy: When we are dealing object with Object.assign(), there will be different
...
/* Structured Clone(Deep Copy): When we are doing a deep copy an Object with Structured Clone,
